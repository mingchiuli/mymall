...
import com.atguigu.mymall.common.utils.HttpUtils;
...
import com.atguigu.mymall.auth.vo.SocialUser;
...
public class OAuth2Controller {
    ...
    public String weibo(@RequestParam("code") String code, HttpSession session) throws Exception {
        ...
        map.put("redirect_uri", "http://auth.localhost/oauth2.0/weibo/success");
        map.put("code", code);
