...
import com.atguigu.mymall.member.mapper.MemberMapper;
...
import com.atguigu.mymall.member.service.MemberService;
...
public class MemberServiceImpl extends ServiceImpl<MemberMapper, MemberEntity> implements MemberService {
    ...
    @Autowired
    MemberLevelMapper memberLevelDao;
    ...
    public void regist(MemberRegistVo vo) throws PhoneExistException, UsernameExistException {
        MemberMapper memberDao = this.baseMapper;
        //要保存的大对象
