...
import com.atguigu.mymall.product.feign.fallback.SeckillFeignServiceFallBack;
...
@FeignClient(value = "mymall-seckill", fallback = SeckillFeignServiceFallBack.class)//这个远程服务
